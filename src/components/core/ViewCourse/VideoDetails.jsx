...
const VideoDetails = () => {
  ...
  console.log("Params:", { courseId, sectionId, subSectionId });
// console.log("courseSectionData:", courseSectionData);

if (!sectionId || !subSectionId) {
  console.warn("VideoDetails mounted with missing params:", { courseId, sectionId, subSectionId });
}
...
// console.log(useParams);
  useEffect(()=> {
    ...
    console.warn("Subsection not found for subSectionId:", subSectionId);
    return;
}
